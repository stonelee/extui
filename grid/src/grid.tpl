...
<div class="bd" style="background-color:white;">
  ...
  <div class="grid-ft">
    ...
    <span class="grid-ft-text">当前第</span>
    <input class="form-text" style="width:40px;" type="text" data-role="num">
    <span class="grid-ft-text">/10页</span>
    <i class="grid-separator"></i>
    ...
    <span class="grid-ft-text" style="float:right;margin-right:100px;">共{{totalCount}}条记录，每页{{pageSize}}条</span>
  </div>
</div>
